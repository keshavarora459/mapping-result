...
class ConnectionMapper:
    ...
    def _build_raw_table_mquery(
        ...
        # 3. Mapping tables (e.g. TruckMap)
        if load_type == "mapping" or table_name.lower() == "truckmap" or "mapping load" in (qlik_query or "").lower():
            target_upstream = upstream_table or "Trucks"
            if qlik_query:
            ...
            return (
                ...
                f'    #"Removed Other Columns" = Table.SelectColumns(Source, {{"truck_id", "unit_number"}}),\n'
